...
const getThemeHexColor = (themeName) => {
  switch (themeName) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {teamMembers.map((member) => {
              ...
              for (let i = 0; i < 30; i++) {
                ...
                const avg = sum / count;
                const x = (i / 29) * width;
                const y = height - (avg / 100) * (height - 4) - 2;
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="h-6 w-24 relative select-none" title="Smooth 30-day presence heart-rate trend">
                        <svg viewBox="0 0 100 18" width="100%" height="100%">
                          ...
                          <path d={areaPathData} fill={`url(#sparkline-grad-${member.id})`} />
                          <path
                            d={pathData}
                            fill="none"
                            stroke={themeHex}
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-[2.5px] w-full">
                        {presenceCalendar.map((day) => {
                          ...
                          if (day.hasSubmitted) {
                            if (day.mood === "excellent") { markerBg = "bg-emerald-400"; moodText = "Excellent mood"; }
                            else if (day.mood === "good") { markerBg = "bg-teal-400"; moodText = "Good mood"; }
                            else if (day.mood === "neutral") { markerBg = "bg-blue-400"; moodText = "Neutral mood"; }
                            else if (day.mood === "unhappy") { markerBg = "bg-amber-500"; moodText = "Unhappy mood"; }
                            else if (day.mood === "stressed") { markerBg = "bg-rose-500"; moodText = "Stressed state"; }
                            else { markerBg = "bg-emerald-450"; moodText = "Submitted"; }
                          }
