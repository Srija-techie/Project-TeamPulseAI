...
export default function Sidebar() {
  ...
  if (user?.role !== "Admin") {
    menuItems.push({ view: "subscription", label: "My Plan", icon: CreditCard });
  }

  if (user?.role === "Admin") {
    menuItems.push({ view: "settings", label: "Schedule Settings", icon: Settings });
  }

  if (user?.role === "Admin") {
    menuItems.push({ view: "admin", label: "👑 Admin Portal", icon: Award });
  }
