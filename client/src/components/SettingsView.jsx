...
export default function SettingsView() {
  ...
  const [selectedWeekdays, setSelectedWeekdays] = useState(["Mon", "Tue", "Wed", "Thu", "Fri"]);
  const [remindersEnabled, setRemindersEnabled] = useState(true);
  const [slackChannel, setSlackChannel] = useState("#scrum-updates");
  const [emailMailingList, setEmailMailingList] = useState("");
  ...
  const [slackWebhookAlerts, setSlackWebhookAlerts] = useState(false);
              ...
              {user?.role !== "Admin" && (
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4 flex items-start space-x-3">
                  ...
                  <div className="text-xs text-gray-300">
                    <p className="font-semibold text-amber-400 mb-1">Admin Access Required</p>
                    <p>Only administrators can modify workspace settings, custom questions, and schedule configurations.</p>
                  </div>
                </div>
              )}
              ...
              <form onSubmit={handleUpdateSchedule} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`block w-full px-3.5 py-2.5 bg-[#0c0d10] border border-gray-800 rounded-xl text-gray-205 focus:outline-none focus:ring-2 focus:ring-${theme.primary}/10 focus:border-${theme.primary} text-xs font-sans ${user?.role !== "Admin" ? "opacity-50 cursor-not-allowed" : ""}`}
                  />
                ...
                <div className="space-y-4">
                    ...
                    {questions.map((q, idx) => (
                      <div key={idx} className="flex items-center justify-between p-3 bg-[#0c0d10] rounded-xl border border-gray-800 font-sans">
                        ...
                        <button
                          ...
                          disabled={user?.role !== "Admin"}
                          className={`p-1.5 text-gray-500 hover:text-rose-500 hover:bg-rose-500/10 rounded-lg transition-all cursor-pointer ${user?.role !== "Admin" ? "opacity-50 cursor-not-allowed" : ""}`}
                        >
                  ...
                  <div className="flex items-center space-x-2 pt-2">
                    <input
                      ...
                      disabled={user?.role !== "Admin"}
                      className={`block flex-1 px-3.5 py-2 border border-gray-800 bg-[#0c0d10] text-gray-200 focus:outline-none focus:ring-2 focus:ring-${theme.primary}/10 focus:border-${theme.primary} text-sm placeholder-gray-650 font-sans rounded-xl ${user?.role !== "Admin" ? "opacity-50 cursor-not-allowed" : ""}`}
                    />
                    <button
                      type="button"
                      onClick={handleAddQuestion}
                      disabled={user?.role !== "Admin"}
                      className={`py-2 px-3.5 ${theme.bgOpacity} ${theme.textAccent} hover:${theme.bgAccentHover}/20 border ${theme.borderAccent} rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center space-x-1 ${user?.role !== "Admin" ? "opacity-50 cursor-not-allowed" : ""}`}
                    >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        disabled={user?.role !== "Admin"}
                        className={`block w-full pl-10 pr-3 py-2 border border-gray-800 bg-[#0c0d10] text-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-${theme.primary}/10 focus:border-${theme.primary} text-sm font-sans ${user?.role !== "Admin" ? "opacity-50 cursor-not-allowed" : ""}`}
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        disabled={user?.role !== "Admin"}
                        className={`block w-full pl-10 pr-3 py-2.5 border border-gray-800 bg-[#0c0d10] rounded-xl focus:outline-none focus:ring-2 focus:ring-${theme.primary}/10 focus:border-${theme.primary} text-xs font-sans text-gray-300 ${user?.role !== "Admin" ? "opacity-50 cursor-not-allowed" : ""}`}
                      >
                ...
                <div className="flex justify-end border-t border-gray-850 pt-5">
                  <button
                    ...
                    className={`py-2.5 px-6 shrink-0 ${theme.bgAccent} hover:${theme.bgAccentHover} text-white rounded-xl text-xs font-bold flex items-center justify-center space-x-1.5 transition-all shadow-lg ${theme.shadowAccent} cursor-pointer ${user?.role !== "Admin" ? "opacity-50 cursor-not-allowed" : ""}`}
                  >
